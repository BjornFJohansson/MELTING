...
\subsubsection{DMSO corrections, DMSO in percentage}
  \begin{itemize}
  \item textit{ahs01}
  \begin{displaymath}
...
\subsubsection{formamide corrections}
  ...
  \item textit{bla96}
  \begin{displaymath}
  Tm=Tm(formamide=0)+ (0.453 x Fgc - 2.88) x formamide
  \end{displaymath}
...
\textbf{correction} & \textbf{limits} & \textbf{Article} \\
\hline 
\textbf{bla96} & DNA & R. D. Blake et al., 1996 \\
