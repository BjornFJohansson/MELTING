...
/**
 * This class represents the sodium correction model owc2204. It implements the CorrectionMethod interface.
 * 
 ...
 */
public class Owczarzy04SodiumCorrection22
  implements CorrectionMethod, NamedMethod
{
   ...
   */
  private static String methodName = "Owczarzy et al. (2004) (22)";
	...
	public boolean isApplicable(Environment environment) {
		...
		if (environment.getHybridization().equals("dnadna") == false){
			OptionManagement.logWarning("\n The sodium correction of Owczarzy et al. (2004) 22 is originally established for " +
			"DNA duplexes.");
