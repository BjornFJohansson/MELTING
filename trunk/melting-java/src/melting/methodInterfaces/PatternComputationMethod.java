...
public interface PatternComputationMethod {
	 ...
	 * @param int pos1. Start position of the pattern in the sequence.
	 * @param int pos2. End position of the pattern in the sequence. 
	...
	/**
	 * 
	 * @param NucleotidSequences sequences which contains the sequences entered by the user.
     * @param int pos1. Start position of the pattern in the sequence.
	 * @param int pos2. End position of the pattern in the sequence.
	 * @param ThermoResult result which contains the computed enthalpy, entropy and melting temperature.
	 ...
	 * @param HashMap<String, String> options which contains the current options. (default options and options entered by the user)
	 */
	public void loadData(HashMap<String, String> options);
		
	/**
	 * To load the thermodynamic parameters from the file "name" and stock them in the map of a DataCollect object.
	 * @param String name : the file name where to find the thermodynamic parameters
	 * @param DataCollect collector : The object which stocks the different thermodynamic parameters in a map.
	 */
