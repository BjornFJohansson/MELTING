 ...
 */
public class MainTestTandemLockedAcidNucleic {

	public static void main(String[] args) {
		ArrayList<String> lockedAcidNucleicMethods = new ArrayList<String>();
        lockedAcidNucleicMethods.add("owc11");

		Properties lockedAcidNucleicSequences = MainTest.loadSequencesTest("src/examples/test/tandemLockedAcidNucleicSequences.txt");
