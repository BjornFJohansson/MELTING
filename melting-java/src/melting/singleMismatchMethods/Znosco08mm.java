...
public class Znosco08mm extends ZnoscoMethod {
	...
	public ThermoResult calculateThermodynamics(NucleotidSequences sequences,
		...
		OptionManagement.meltingLogger.log(Level.FINE, "The thermodynamic parameters for single mismatches are from Znosco et al. (2008) : " + formulaEnthalpy + " (entropy formula is similar)");
