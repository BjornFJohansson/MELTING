...
\item [\textbf{-IC} \textit{inputC\_file}]\mbox{}\\
  ...
  ignored. 
\item [\textbf{-IOF} \textit{inputOF\_file}]\mbox{}\\  
  To read a set of input sequences in an input file. 'filename' is the name or the full path to the file. 
...
\item [\textbf{-w} \textit{sliding window value}  ]\mbox{}\\
...
\url{http://www.ebi.ac.uk/biomodels/tools/melting/}
  
You can use \textsc{melting} through a web server at 
\url{http://bioweb.pasteur.fr/seqanal/interfaces/melting.html}
\url{http://www.ebi.ac.uk/biomodels/tools/melting/melt.php}   
   
\section{Copyright }
Melting is copyright 
\copyright 1997, 2017 jointly by the following organizations:
...
correction. Thanks to Charles Plessy for the graphical interface files. Thanks
to Daniel McGreal for the SOAP interface of MELTING at the EMBL-EBI. Thanks to
Nicolas Rodriguez for the current web interface and GUI client and finally
...
contact: melting-forum@googlegroups.com
