...
\begin{figure}[h]
\includegraphics{images/DNAPrefectlyMatching.eps}
...
\begin{figure}[h]
\includegraphics{images/RNAPrefectlyMatching.eps}
\caption{Comparison of experimental and computed Tm for various sets of
...
\item if \frac{[\mbox{Mg}^{2+}]^0.5}{[\mbox{Mon}^+]} < 0.22, a default sodium correction is used.
Monovalent ion influence is dominant, divalent cations can be 
disregarded.
\item if \frac{[\mbox{Mg}^{2+}]^0.5}{[\mbox{Mon}^+]} >= 0.22 and \frac{[\mbox{Mg}^{2+}]^0.5}{[\mbox{Mon}^+] < 6, 
...
\end{table}
  ...
  \item textit{lincorr}
  \begin{displaymath}
  Tm (x % formamide) = Tm(0 % formamide) - 0.65 * x % formamide
